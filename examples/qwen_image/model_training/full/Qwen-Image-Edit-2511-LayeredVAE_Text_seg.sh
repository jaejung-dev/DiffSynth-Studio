...
accelerate launch --config_file examples/qwen_image/model_training/full/accelerate_config_zero2offload.yaml examples/qwen_image/model_training/train.py \
  ...
  --dataset_metadata_path "/home/ubuntu/for_jjseol/qwen_text_seg/train50k.json,/home/ubuntu/for_jjseol/qwen_fg_seg/train50k.json" \
  ...
  --output_path "./models/train/Qwen-Image-Edit-2511_full_layered_vae_text_fg_seg" \
