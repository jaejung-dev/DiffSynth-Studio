...
accelerate launch examples/qwen_image/model_training/train.py \
  --dataset_base_path "/home/ubuntu/for_jjseol/qwen_fg_seg" \
  --dataset_metadata_path "/home/ubuntu/for_jjseol/qwen_fg_seg/train100k.json" \
  ...
  --output_path "./models/train/Qwen-Image-Edit-2511_lora_layered_vae_fg_seg" \
  --lora_base_model "dit" \
